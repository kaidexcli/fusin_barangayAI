# Contributing to Loompoint

Thanks for wanting to help. This project exists so people at Loompoint camps and in communities can run their own private AI — contributions that make it simpler, faster on low-end laptops, or friendlier in Filipino languages are especially welcome.
...
1. **Fork** [`Spod101/loompoint`](https://github.com/Spod101/loompoint) (Fork button, top-right on GitHub), then clone your fork:

   ```bash
   git clone https://github.com/YOUR-USERNAME/loompoint.git
   cd loompoint
   ```
...
5. **Push** to your fork and **open a pull request** against `Spod101/loompoint` `main`.
